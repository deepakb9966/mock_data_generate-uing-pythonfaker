...
class UploadJsonFileToFirestore:
    def __init__(self,method,collectionname,patientId,_json_data) :
        ...
        # d = json.load(data)
        # print(d)
        # _json_data = '/home/deep/Desktop/mock_data_generator-main/server/openapi_server/bp_mock.json'
    ...
    def json_data(self, val):
        if val:
            try:
                ...
                # make sure to close file["FVNTu8vnH9QMLDH24CPGn7mm2In2"]
                f.close()
    ...
    def set(self, item):
        # print(item)
        # return db.collection("Patient").document(self.patientId).set(item)
        return db.collection("Patient").document().set(item)

# uploadjson = UploadJsonFileToFirestore('set','vital','/home/deep/Desktop/mock_data_generator-main/server/openapi_server/bp_mock.json')
# uploadjson.upload()
